...
{
	public partial class Ball : PositionedObject, IDestroyable
	{
		...
		protected static Microsoft.Xna.Framework.Graphics.Texture2D ball;
		
		private FlatRedBall.Sprite SpriteInstance;
		private FlatRedBall.Math.Geometry.Circle mCollisionBox;
		public FlatRedBall.Math.Geometry.Circle CollisionBox
		{
			get
			{
		...
		protected virtual void InitializeEntity(bool addToManagers)
		{
			...
			mCollisionBox = new FlatRedBall.Math.Geometry.Circle();
...
// Generated AddToManagers
		...
		public virtual void PostInitialize ()
		{
			...
			CollisionBox.Color = Color.DarkOrange;
			CollisionBox.Radius = 7f;
		...
		public virtual void AssignCustomVariables (bool callOnContainedElements)
		{
			...
			SpriteInstance.Texture = ball;
			SpriteInstance.TextureScale = 1f;
			mCollisionBox.Color = Color.DarkOrange;
			mCollisionBox.Radius = 7f;
		...
		public static void LoadStaticContent (string contentManagerName)
		{
			...
			if (LoadedContentManagers.Contains(contentManagerName) == false)
			{
				...
				lock (mLockObject)
				{
					...
					{
						FlatRedBallServices.GetContentManagerByName(ContentManagerName).AddUnloadMethod("BallStaticUnload", UnloadStaticContent);
						mRegisteredUnloads.Add(ContentManagerName);
					}
				}
				if (!FlatRedBallServices.IsLoaded<Microsoft.Xna.Framework.Graphics.Texture2D>(@"content/entities/ball/ball.png", ContentManagerName))
				{
					registerUnload = true;
				}
				ball = FlatRedBallServices.Load<Microsoft.Xna.Framework.Graphics.Texture2D>(@"content/entities/ball/ball.png", ContentManagerName);
			}
